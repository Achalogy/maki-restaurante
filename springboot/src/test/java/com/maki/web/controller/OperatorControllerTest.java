 ...
 *
 * <p>Se usa @WebMvcTest para levantar únicamente la capa web del controlador, sin arrancar toda la
 * aplicación. Esto hace las pruebas más rápidas.
 *
 * <p>Se usa @MockBean para simular el OperatorService, ya que lo que queremos probar es el
 * comportamiento del controlador, no del servicio.
 *
 * <p>Cubrimos 1 prueba de cada tipo HTTP: GET all, GET by id, POST crear, POST actualizar, DELETE,
 * y POST login.
 */
...
@Import({
    com.maki.web.security.SecurityConfig.class,
    com.maki.web.dtos.MakiMapper.class,
})
public class OperatorControllerTest {
    ...
    public void operatorController_getAllOperators_returnsList() throws Exception {
        ...
        ResultActions result =
                mockMvc.perform(get("/api/v1/operator").contentType(MediaType.APPLICATION_JSON));
    ...
    public void operatorController_getOperatorById_returnsOperator() throws Exception {
        ...
        // Act
        ResultActions result =
                mockMvc.perform(get("/api/v1/operator/1").contentType(MediaType.APPLICATION_JSON));
    ...
    public void operatorController_getOperatorById_notFound_returns404() throws Exception {
        ...
        when(operatorService.selectById(999L))
                .thenThrow(
                        new com.maki.web.exception.EntityNotFoundException(
    ...
    public void operatorController_countOperatorsByUsername_returnsCount() throws Exception {
        ...
        // Assert
        result.andExpect(status().isOk()).andExpect(content().string("1"));
    }
