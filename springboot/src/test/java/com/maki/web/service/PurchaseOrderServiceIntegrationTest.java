...
/**
 * Pruebas de integración para PurchaseOrderServiceImpl. Se basa en PlateCRUDTest para la
 * configuración de integración con H2 y Spring Context. Al usar @Transactional, cada prueba hace
 * rollback al finalizar, manteniendo la DB limpia.
 */
@ActiveProfiles("test")
...
public class PurchaseOrderServiceIntegrationTest {
    ...
    public void setUp() {
        ...
        testClient =
                new Client("Juan", "Perez", "juan.it@example.com", "pass123", "1234567", "Calle 1");
        testClient = clientRepository.save(testClient);

        testCategory = new Category("Sushi");
        testCategory = categoryRepository.save(testCategory);

        testDelivery = new Delivery("Juan Domiciliario", "123", "123", true, false);
    }

    @Test
    public void insert_Pedido_Vacio_GuardaEnBaseDeDatos() throws EntityConstraintException {
        // Arrange
        ...
        assertNull(order.getDelivery()); // No debería tener un delivery asignado
    }
    ...
    public void insert_Pedido_Y_Asignar_Domiciliario_Disponible() {
        ...
        assertDoesNotThrow(() -> purchaseOrderService.setDelivery(saved.getId(), saved_delivery));
    }
    ...
    public void insert_Pedido_Y_Asignar_Domiciliario_Ocupado() {
        ...
        assertThrows(
                EntityConstraintException.class,
    ...
    @Test
    public void selectNotCompleted_FiltraPedidosCorrectamente() throws EntityConstraintException {
        // Arrange
        ...
        assertTrue(results.stream().noneMatch(o -> "completed".equals(o.getStatus())));
    }
    ...
    public void createPurchaseOrderFromcart_CreaPedidoYDetallesIntegrados() {
        ...
        PurchaseOrder createdOrder =
                purchaseOrderService.createPurchaseOrderFromcart(testClient.getId(), cart);
    ...
    public void deleteByID_EliminaPedidoYDependencias()
        ...
        // Assert
        assertThrows(EntityNotFoundException.class, () -> purchaseOrderService.selectById(id));
    }
}
