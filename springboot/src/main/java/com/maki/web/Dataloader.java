...
public class Dataloader implements CommandLineRunner {
    ...
    @Autowired private AdministratorRepository adminRep;
    @Autowired private OperatorRepository operatorRepo;
    @Autowired private PurchaseOrderRepository orderRepo;
    @Autowired private OrderDetailsRepository orderDetallesRepo;

    @Autowired private DeliveryRepository deliveryRepo;
    @Autowired private AdditionalOrderDetailsRepository additionalPedidoDetallesRepo;
    ...
    public void run(String... args) throws Exception {
        ...
        userEntity =
                createUserEntity(
                        operatorSave.getUsername(), operatorSave.getPassword(), "OPERATOR");
        ...
        Delivery delivery2 = new Delivery("Gonzalez", "102", "11010102", true, true);
        ...
        AdditionalOrderDetails additionalDetalle1 =
        ...
        AdditionalOrderDetails additionalDetalle2 =
                new AdditionalOrderDetails(
        ...
        AdditionalOrderDetails additionalDetalle3 =
                new AdditionalOrderDetails(
        ...
        AdditionalOrderDetails additionalDetalle4 =
                new AdditionalOrderDetails(
        ...
        AdditionalOrderDetails additionalDetalle5 =
                new AdditionalOrderDetails(
