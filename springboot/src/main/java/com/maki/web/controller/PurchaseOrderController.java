...
public class PurchaseOrderController {
    ...
    public ResponseEntity<PurchaseOrderDTO> createPurchaseOrder(
        ...
        try {
            PurchaseOrder order =
                    purchaseOrderService.createPurchaseOrderFromcart(client.getId(), plates);
    ...
    public ResponseEntity<PurchaseOrderDTO> updatePurchaseOrder(
            @PathVariable Long id, @RequestBody(required = false) PurchaseOrder data) {
        try {
            ...
            if (data.getDelivery_date() != null)
                updateData.setDelivery_date(data.getDelivery_date());
