...
public class AdministratorController {
    ...
    public List<AdministratorDTO> getAllAdministrators() {
        return AdministratorService.selectAll().stream()
    ...
    public ResponseEntity<AdministratorDTO> getAdministratorById(@PathVariable Long id) {
        try {
            ...
            return new ResponseEntity<>(
                    AdministratorMapper.INSTANCE.toDTO(administrator), HttpStatus.OK);
        } catch (Exception e) {
    ...
    // ===================== CREATE =====================
    @PostMapping("")
    public ResponseEntity<AdministratorDTO> saveAdministrator(
        ...
        try {
            ...
            return new ResponseEntity<>(
                    AdministratorMapper.INSTANCE.toDTO(savedAdmin), HttpStatus.OK);
        } catch (Exception e) {
    ...
    public ResponseEntity<AdministratorDTO> updateAdministrator(
            @PathVariable Long id, @RequestBody(required = false) Administrator data) {
        try {
        ...
        try {
            return new ResponseEntity<>(
                    AdministratorMapper.INSTANCE.toDTO(
                            AdministratorService.verifyCredentials(
