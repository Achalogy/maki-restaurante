...
/**
 * Implementación de OrderDetailsService. Maneja la lógica de negocio para detalles de pedidos
 * incluyendo operaciones CRUD y consultas personalizadas. Gestiona la limpieza de
 * AdditionalOrderDetails relacionados al eliminar.
 */
@Service
public class OrderDetailsServiceImpl implements OrderDetailsService {
                ...
                .orElseThrow(
                        () ->
                                new EntityNotFoundException(
                                        "Detalle de pedido no encontrado: " + id));
    }
     ...
     * @throws EntityConstraintException si la entidad tiene un ID (debería ser null para nuevas
     *     entidades)
     */
    @Override
    ...
    /**
     * Elimina un detalle de pedido por su ID. Primero elimina todos los AdditionalOrderDetails
     * asociados antes de eliminar la entidad principal.
     *
        ...
        OrderDetails detalle =
                repo.findById(id)
                        .orElseThrow(
                                () ->
                                        new EntityNotFoundException(
                                                "No se puede eliminar: Detalle no encontrado"));
    ...
    public OrderDetails update(OrderDetails entity)
        ...
        if (entity.getId() == null || !repo.existsById(entity.getId())) {
            throw new EntityNotFoundException(
                    "No se puede actualizar: Detalle de pedido no existe");
        }
        return repo.save(entity);
    }
