...
public class AdminLoginAddPlate {
    ...
    public void Admin_Login_Wrong_Credentials() {
        ...
        assertTrue(driver.getCurrentUrl().contains("/client/log-in"),
        ...
        assertTrue(driver.getCurrentUrl().contains("/admin/log-in"),
        ...
        WebElement errorMessage = wait.until(
            ExpectedConditions.visibilityOfElementLocated(By.id("invalid-credentials-error"))
        );
    ...
    public void Admin_Login_Correct_Go_To_PlatePanel() {
        ...
        assertTrue(driver.getCurrentUrl().equals(BASE_URL + "/admin"),
