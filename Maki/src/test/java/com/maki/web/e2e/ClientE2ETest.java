...
public class ClientE2ETest {
    ...
    public void caso1_login_ConCredencialesValidas_RedireccionaAlPerfil() {
        ...
        assertTrue(urlActual.contains("/client/"),
        ...
        assertTrue(textoEmail.isDisplayed(),
    ...
    public void caso1_login_ConPasswordIncorrecta_MuestraAlerta() {
        ...
        driver.findElement(By.id("input-email")).sendKeys(CLIENT_EMAIL);
        driver.findElement(By.id("input-password")).sendKeys("password_incorrecta_123");
        driver.findElement(By.id("btn-login")).click();
        ...
        try {
            ...
            assertTrue(mensajeAlerta.toLowerCase().contains("credencial") ||
            ...
            assertFalse(driver.getCurrentUrl().contains("/client/" + CLIENT_ID),
    ...
    public void caso2_menu_Agregar2Platoscon2AdicionalesYVerificarCarrito() {
        ...
        assertEquals(2, itemsEnCarrito.size(),
        ...
        for (WebElement item : itemsEnCarrito) {
            ...
            assertEquals(2, adicionalesDelItem.size(),
    ...
    public void caso3_flujoCompleto_LoginAgregarPedidoYVerificarHistorial() {
        ...
        assertTrue(nombresTexto.contains(nombrePlato1),
                "El carrito debe contener el plato: " + nombrePlato1);
        assertTrue(nombresTexto.contains(nombrePlato2),
        ...
        assertTrue(totalCarritoNumerico > 0,
        ...
        try {
            ...
            assertTrue(mensajeAlert.toLowerCase().contains("pedido"),
        ...
        List<String> nombresItemsOrden = itemsDeOrden.stream()
                .map(WebElement::getText)
                .toList();

        assertTrue(nombresItemsOrden.contains(nombrePlato1),
                "La orden en el historial debe tener el plato: " + nombrePlato1);
        assertTrue(nombresItemsOrden.contains(nombrePlato2),
        ...
        for (WebElement item : todosLosItems) {
            ...
            assertTrue(adicionalesDelItem.size() >= 2,
        ...
        assertFalse(totalesDeOrdenes.isEmpty(),
                "La orden debe mostrar un total");
        ...
        assertTrue(totalHistorialNumerico > 0,
