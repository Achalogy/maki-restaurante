...
/**
 * Interfaz de servicio para la lógica de negocio de OrderDetails.
 * Extiende ServiceInterface para operaciones CRUD estándar.
 * Define métodos para encontrar detalles de pedido por ID de pedido o ID de cliente.
 */
