...
public class MenuRepository {
        ...
        public MenuRepository(CategoriasRepository categoriasRepository) {
                this.categoriasRepository = categoriasRepository;
                this.none = categoriasRepository.getById(1);
        ...
        public void updateCategoria(Integer platoId, Categoria categoria) {
                Plato plato = menu.get(platoId);
                if (plato != null) {
