...
public class PlatoRepository implements RepositoryInterface<Plato> {
        private Map<Integer, Plato> platos = new HashMap<>();
        ...
        public PlatoRepository() {
                ...
                platos.put(2, new Plato(2, "Ramen", 47960,
                                ...
                                "https://images.unsplash.com/photo-1638866281450-3933540af86a?w=500", true, none));
                platos.put(3, new Plato(3, "Tempura", 43960,
                                ...
                                "https://images.unsplash.com/photo-1677743537607-f7fc9273ec4d?w=500", true, none));
                platos.put(4, new Plato(4, "Tonkatsu", 55960,
                                ...
                                "https://images.unsplash.com/photo-1734775373504-ff24ea8419b2?w=500", true, none));
                platos.put(5, new Plato(5, "Gyoza", 31960,
                                ...
                                "https://images.unsplash.com/photo-1738681336104-608b4e7dc3b0?w=500", true, none));
                platos.put(6, new Plato(6, "Edamame", 23960,
                                ...
                                "https://images.unsplash.com/photo-1575262599410-837a72005862?w=500", true, none));
                platos.put(7, new Plato(7, "Sopa Miso", 15960,
                                ...
                                "https://images.unsplash.com/photo-1610393069309-2607fcf74146?w=500", true, none));
                platos.put(8, new Plato(8, "Rollo California", 39960,
                                ...
                                "https://images.unsplash.com/photo-1559410545-0bdcd187e0a6?w=500", true, none));
                platos.put(9, new Plato(9, "Rollo Dragón", 59960,
                                ...
                                "https://images.unsplash.com/photo-1712192674556-4a89f20240c1?w=500", true, none));
                platos.put(10, new Plato(10, "Rollo Philadelphia", 47960,
                                ...
                                "https://images.unsplash.com/photo-1759646828324-c215a83828ae?w=500", true, none));
                platos.put(11, new Plato(11, "Yakitori", 43960,
                                ...
                                "https://images.unsplash.com/photo-1708597525178-6c302364f37c?w=500", true, none));
                platos.put(12, new Plato(12, "Okonomiyaki", 51960,
                                ...
                                none));
                platos.put(13, new Plato(13, "Takoyaki", 35960,
                                ...
                                none));
                platos.put(14, new Plato(14, "Unagi Don", 55960,
                                ...
                                true, none));
                platos.put(15, new Plato(15, "Katsudon", 51960,
                                ...
                                "https://images.unsplash.com/photo-1624517607896-bb5dfd8f5764?w=500", true, none));
                platos.put(16, new Plato(16, "Chirashi", 59960,
                                ...
                                "https://images.unsplash.com/photo-1565967531713-45739e0cad63?w=500", true, none));
                platos.put(17, new Plato(17, "Sukiyaki", 67960,
                                ...
                                "https://images.unsplash.com/photo-1648977555545-4dd006e30d3f?w=500", true, none));
                platos.put(18, new Plato(18, "Shabu Shabu", 63960,
                                ...
                                "https://images.unsplash.com/photo-1559602580-78f1ba809b92?w=500", true, none));
                platos.put(19, new Plato(19, "Nigiri de Salmón", 43960,
                                ...
                                "https://images.unsplash.com/photo-1680675228874-9b9963812b7c?w=500", true, none));
                platos.put(20, new Plato(20, "Res Wagyu", 99960,
                                ...
                                "https://images.unsplash.com/photo-1708388464912-d4ad82dca990?w=500", true, none));
                platos.put(21, new Plato(21, "Ensalada de Alga Marina", 27960,
                                ...
                                none));
                platos.put(22, new Plato(22, "Tofu Agedashi", 35960,
                                ...
                                "https://images.unsplash.com/photo-1765295218809-784d6c2fe39c?w=500", true, none));
                platos.put(23, new Plato(23, "Yakisoba", 43960,
                                ...
                                "https://images.unsplash.com/photo-1624904025321-24e2f17d06ce?w=500", true, none));
                platos.put(24, new Plato(24, "Pollo Teriyaki", 51960,
                                ...
                                "https://images.unsplash.com/photo-1609183480237-ccbb2d7c5772?w=500", true, none));
                platos.put(25, new Plato(25, "Karaage", 39960,
                                ...
                                "https://images.unsplash.com/photo-1706513045864-e122d45f2f1d?w=500", true, none));
                platos.put(26, new Plato(26, "Tabla de Sashimi", 67960,
                                ...
                                "https://images.unsplash.com/photo-1758384075930-6e3835d22b1d?w=500", true, none));
                platos.put(27, new Plato(27, "Rollo Arcoíris", 63960,
                                ...
                                "https://images.unsplash.com/photo-1636425730652-ffdbada1ed4d?w=500", true, none));
                platos.put(28, new Plato(28, "Tártara de Atún", 47960,
                                ...
                                "https://images.unsplash.com/photo-1656106577512-0259bf5b9fd6?w=500", true, none));
                platos.put(29, new Plato(29, "Maki de Pepino", 31960,
                                ...
                                none));
                platos.put(30, new Plato(30, "Cheesecake Matcha", 27960,
  ...
  public Plato selectById(Integer id) throws EntityNotFoundException {
    ...
    if(p == null) throw new EntityNotFoundException("No hay plato con id=" + id);
    return p;
  }
  ...
  public Plato insert(Plato plato) throws EntityConstraintException {
    ...
    if(old != null) throw new EntityConstraintException("Ya existe una categoría con este id");

    if(plato.getId() == null) {
      List<Integer> ids = new ArrayList<>(platos.keySet());
  ...
  public void deleteByID(Integer id) throws EntityNotFoundException {
    if(platos.get(id) == null) throw new EntityNotFoundException("No existe un plato con id=" + id);
