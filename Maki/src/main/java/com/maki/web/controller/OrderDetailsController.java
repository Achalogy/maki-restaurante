...
/**
 * Controlador REST para endpoints de Detalles de Pedidos.
 * Proporciona endpoints API para obtener artículos de detalles de pedidos por ID de pedido o ID de cliente.
 * Ruta base: /api/v1/order-details
 */
@RestController
...
public class OrderDetailsController {
    ...
    /**
     * Obtiene todos los artículos de detalles de todos los pedidos realizados por un cliente específico.
