...
public class PlateController {
  ...
  public ResponseEntity<PlateDTO> savePlate(
    ...
    try {
      ...
      return new ResponseEntity<>(
        mapper.toPlateDTO(platoService.insert(plato)),
        HttpStatus.OK
      );
    } catch (Exception e) {
  ...
  public ResponseEntity<PlateDTO> updatePlate(
    ...
    try {
      ...
      if (data.getDescription() != null) updateData.setDescription(
        data.getDescription()
      );
      if (data.getUrlImage() != null) updateData.setUrlImage(
        data.getUrlImage()
      );
      ...
      return new ResponseEntity<>(
        mapper.toPlateDTO(platoService.update(updateData)),
        HttpStatus.OK
      );
    } catch (Exception e) {
      return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
