...
public class Dataloader implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    Plate sakeTradditional = new Plate(
      "Sake Tradditional",
      35960,
    ...
    for (Additional additional : additionalRepo.findAll()) {
      ...
      adcatRepo.save(
        new AdditionalCategory((long) randomNum, additional.getId())
      );
    }

    adminRep.save(new Administrator("Miguel", "eveyzoe", "1234"));
    adminRep.save(new Administrator("Tomas", "Neon", "4567"));
    adminRep.save(new Administrator("Juan", "Wonton", "7789"));
    adminRep.save(new Administrator("Alex", "Aliz", "3452"));
    adminRep.save(new Administrator("Akiara", "Starlight", "2231"));
    ...
    Operator operator19 = new Operator(
      (long) 101029,
      "Herrera",
      "natasha.herrera@example.com",
      "123456"
    );
    operatorRepo.save(operator19);
    Operator operator20 = new Operator(
      (long) 101030,
      "Medina",
      "gabriel.medina@example.com",
      "123456"
    );
    ...
    OrderDetails detalle1 = new OrderDetails(
      order1,
      plateRepo.findById(1L).orElse(null),
      2
    );
    orderDetallesRepo.save(detalle1);
    OrderDetails detalle2 = new OrderDetails(
      order1,
      plateRepo.findById(2L).orElse(null),
      1
    );
    orderDetallesRepo.save(detalle2);

    OrderDetails detalle3 = new OrderDetails(
      order2,
      plateRepo.findById(3L).orElse(null),
      3
    );
    orderDetallesRepo.save(detalle3);

    OrderDetails detalle4 = new OrderDetails(
      order2,
      plateRepo.findById(5L).orElse(null),
      2
    );
    orderDetallesRepo.save(detalle4);

    OrderDetails detalle7 = new OrderDetails(
      order2,
      plateRepo.findById((long) random.nextInt(1, 38)).orElse(null),
      random.nextInt(1, 6)
    );
    orderDetallesRepo.save(detalle7);

    AdditionalOrderDetails additionalDetalle1 = new AdditionalOrderDetails(
      orderDetallesRepo.findById(1L).orElse(null),
      additionalRepo.findById(1L).orElse(null)
    );
    additionalPedidoDetallesRepo.save(additionalDetalle1);
    AdditionalOrderDetails additionalDetalle2 = new AdditionalOrderDetails(
      orderDetallesRepo.findById(2L).orElse(null),
      additionalRepo.findById(2L).orElse(null)
    );
    additionalPedidoDetallesRepo.save(additionalDetalle2);
    AdditionalOrderDetails additionalDetalle3 = new AdditionalOrderDetails(
      orderDetallesRepo.findById(3L).orElse(null),
      additionalRepo.findById(3L).orElse(null)
    );
    additionalPedidoDetallesRepo.save(additionalDetalle3);
    AdditionalOrderDetails additionalDetalle4 = new AdditionalOrderDetails(
      orderDetallesRepo.findById(4L).orElse(null),
      additionalRepo.findById(4L).orElse(null)
    );
    additionalPedidoDetallesRepo.save(additionalDetalle4);
    AdditionalOrderDetails additionalDetalle5 = new AdditionalOrderDetails(
      orderDetallesRepo.findById(5L).orElse(null),
      additionalRepo.findById(5L).orElse(null)
    );
