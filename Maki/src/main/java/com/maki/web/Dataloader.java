...
public class Dataloader implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                Operador operador1 = new Operador((long) 101011, "Gomez", "carlos.gomez@example.com", "123456");
                operadorRepo.save(operador1);
                Operador operador2 = new Operador((long) 101012, "Lopez", "maria.lopez@example.com", "123456");
                operadorRepo.save(operador2);
                Operador operador3 = new Operador((long) 101013, "Martinez", "ana.martinez@example.com", "123456");
                operadorRepo.save(operador3);
                Operador operador4 = new Operador((long) 101014, "Garcia", "luis.garcia@example.com", "123456");
